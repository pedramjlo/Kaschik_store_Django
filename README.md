...
- Membership club, consisting of 4 roles;
  - regular: no discount on either orders or shipping fees (the default role). 
...
# The interface
The [frontend](https://github.com/pedramjlo/kaschik_store_reactjs) written with ReactJS + Tailwind
